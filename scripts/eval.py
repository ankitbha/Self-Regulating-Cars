...
Vissim = win32com.client.dynamic.Dispatch("Vissim.Vissim.23")  
print(Vissim)


if 1:  # 988
    basedir = "D:\\vissim experiments\\nyc_nj\\"
    name = ["Mainz", "Mainz-2-bursts", "Mainz-decay", "Mainz20", "Mainz20copy", "Mainz20mix25", "Mainz20mix50", "Mainz20mix75", "Mainz20base25control"][4]
    filename = basedir + name + ".inpx"
    Filename = basedir + name + ".layx"
elif 0:
    filename = r"D:\\vissim experiments\\nyc_nj\\Mainz.inpx"  
    Filename = r"D:\\vissim experiments\\nyc_nj\\Mainz.layx"
else:
    filename = r"D:\\Users\\ra3106\Desktop\\vissim experiments\\base case\\base.inpx"  
